...
$showPaymentStatus = isset($_SESSION['payment_status']) && $_SESSION['payment_status'] === "success";
  ...
  <?php if ($showPaymentStatus): ?>
    <div class="payment-success-overlay">
      <div class="payment-success-container">
        ...
        <p class="payment-success-message">Your payment has been processed successfully. Thank you for your purchase!</p>
        <button class="payment-success-button" onclick="window.location.href='index.php'">Continue Shopping</button>
      </div>
    </div>
  <?php endif; ?>
